 ...
 * Loader trees may namespace entry ids (e.g. the profile patch mounts its
 * rows under an `include:` group), so prefer the stored options id and fall
 * back to the last segment of the full id — the patch rows always carry the
 * bare id.
 */
